...
DEFINE_DIFFUSIVITY(porous_diff,c,t,i)
{
  ...
  Dm = (0.01013*pow(temp,1.75)*pow(1/Mm1_g + 1/Mm2_g,0.5))/(abs_pres*pow(pow(Sum_Dv1,1.0/3.0) + pow(Sum_Dv2,1.0/3.0),2));
...
DEFINE_ADJUST(my_adjust,d)
{
  ...
  thread_loop_c(t, d)
  {
    begin_c_loop(c, t)
    {
      ...
      b01 = 2.09*pow(10,-7);
      b02 = 7.96*pow(10,-7); /* UES model */
      d01 = 1.06*pow(10,-7);
      d02 = 6.94*pow(10,-7); /* UES model */

      qsb1 = 3.257;
      qsb2 = 3.257; /* UES model */
      qsd1 = 3.240;
      qsd2 = 3.240; /* UES model */

      dUb1 = -42670;
      dUb2 = -18860; /* UES model */
      dUd1 = -32210;
      dUd2 = -17760; /* UES model */
